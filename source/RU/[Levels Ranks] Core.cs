...
{   
    public class LevelsRanksCore : BasePlugin, IPointsManager
    {
        ...
        public class PhrasesConfig
        {
            ...
            public string IntroMessage { get; set; } = "Введи: {Purple}!lvl {White}- главное меню";
            public string GetActivePlayerCountMsg { get; set; } = "Присутствует только {DarkRed}{CURRENT_PLAYERS} {White}игроков из {DarkRed}{MIN_PLAYERS}";
            public string PointsChangeMessage { get; set; } = "Ваш опыт:{COLOR} {POINTS} [{SIGN}{CHANGE_POINTS} за {REASON}]";
            ...
            public string RankCommandMessage { get; set; } = "Звание: {Green}{RANK_NAME} {White}| Место: {Blue}{PLACE}/{TOTAL_PLAYERS} {White}| Опыт: {Gold}{POINTS} {White}| Убийства: {Green}{KILLS} {White}| Смерти: {DarkRed}{DEATHS} {White}| KDR: {Yellow}{KDR} {White}| Время на сервере: {Gold}{PLAY_TIME}";                                                            
            ...
            public string TopCommandNoDataMessage { get; set; } = "[ {DarkRed}Ошибка{White} ] Нет данных о топ игроках."; 
            public string TopCommandErrorMessage { get; set; } = "[ {DarkRed}Ошибка{White} ] Произошла ошибка при выполнении команды."; 
            ...
            public string TopKillsCommandNoDataMessage { get; set; } = "[ {DarkRed}Ошибка{White} ] Нет данных о топ игроках по убийствам.";
            public string TopKillsCommandErrorMessage { get; set; } = "[ {DarkRed}Ошибка{White} ] Произошла ошибка при выполнении команды.";
            public string TopDeathsCommandIntroMessage { get; set; } = "[ {DarkRed}Топ игроков по смертям{White} ]";
            public string TopDeathsCommandPlayerMessage { get; set; } = "{INDEX}. {Grey}{NAME}{White} - {DarkRed}{DEATHS} смертей{White}";
            public string TopDeathsCommandNoDataMessage { get; set; } = "[ {DarkRed}Ошибка{White} ] Нет данных о топ игроках по смертям.";
            public string TopDeathsCommandErrorMessage { get; set; } = "[ {DarkRed}Ошибка{White} ] Произошла ошибка при выполнении команды."; 
            ...
            public string TopKDRCommandNoDataMessage { get; set; } = "[ {DarkRed}Ошибка{White} ] Нет данных о топ игроках по KDR.";
            public string TopKDRCommandErrorMessage { get; set; } = "[ {DarkRed}Ошибка{White} ] Произошла ошибка при выполнении команды.";
            ...
            public string TopTimeCommandNoDataMessage { get; set; } = "[ {DarkRed}Ошибка{White} ] Нет данных о топ игроках по времени на сервере.";
            public string TopTimeCommandErrorMessage { get; set; } = "[ {DarkRed}Ошибка{White} ] Произошла ошибка при выполнении команды.";
            public string TopTimeFormat { get; set; } = "{0}д {1}ч {2}мин";     
            public string ResetStatsCooldownMessage { get; set; } = " {DarkRed}[LR]{White}  Сбросить статистику можно только раз в 3 часа.";
            public string ResetStatsSuccessMessage { get; set; } = " {DarkRed}[LR]{White}  Ваша статистика сброшена.";  
            ...
            public string RanksCommandNoDataMessage { get; set; } = "[ {DarkRed}Ошибка{White} ] Нет данных о званиях.";
            public string RanksCommandErrorMessage { get; set; } = "[ {DarkRed}Ошибка{White} ] Произошла ошибка при выполнении команды.";
            ...
            public string MainMenuTitle { get; set; } = "Главное меню";
            public string StatsMenuOption { get; set; } = "-> Статистика";
            public string TopPlayersMenuOption { get; set; } = "-> Топ игроков";
            public string RanksListMenuOption { get; set; } = "-> Список всех званий";  
            public string TopPlayersMenuTitle { get; set; } = "Топ игроков";
            public string TopPointsOption { get; set; } = "-> Топ 10 по очкам опыта";
            public string TopKillsOption { get; set; } = "-> Топ 10 по убийствам";
            public string TopDeathsOption { get; set; } = "-> Топ 10 по смертям";
            public string TopKDROption { get; set; } = "-> Топ 10 по KDR";
            public string TopTimeOption { get; set; } = "-> Топ 10 по времени";
            public string BackToMainMenuOption { get; set; } = "-> {Red}Назад в главное меню";
            public string StatsMenuTitle { get; set; } = "Статистика";
            public string MyStatsOption { get; set; } = "-> Моя статистика";
            public string ResetStatsOption { get; set; } = "-> Сброс статистики";
            public string BackToMainMenuFromStatsOption { get; set; } = "-> {Red}Назад в главное меню";
            public string ResetStatsConfirmationTitle { get; set; } = "Вы уверены, что хотите сбросить статистику?";
            public string ResetStatsConfirmOption { get; set; } = "-> {Green}Да";
            public string ResetStatsDenyOption { get; set; } = "-> {Red}Нет";     
            public string RanksMenuTitle { get; set; } = "Список званий";
            public string RankMessageFormat { get; set; } = "{0} - {1} опыта"; 
        }
        ...
        public void SaveConfig(PluginConfig config, string filePath)
        {
            ...
            stringBuilder.AppendLine("# Настройка плагина Levels Ranks");
            stringBuilder.AppendLine();
            stringBuilder.AppendLine("# Минимальное количество игроков для начисления опыта");
            stringBuilder.AppendLine($"MinPlayersForExperience: {config.MinPlayersForExperience}");
            stringBuilder.AppendLine();
            stringBuilder.AppendLine("# Включение или выключение начисления очков за убийство ботов");
            ...
            stringBuilder.AppendLine();
            stringBuilder.AppendLine("# Через сколько часов можно будет снова сбросить статистику");
            stringBuilder.AppendLine($"ResetStatsCooldownHours: {config.ResetStatsCooldownHours}");
            stringBuilder.AppendLine();
            stringBuilder.AppendLine("# Включение или выключение серий убийств");
            stringBuilder.AppendLine($"# Если true, серии убийств будут учитываться и давать дополнительные очки");
        ...
        public void SaveStatsConfig(StatsConfig config, string filePath)
        {
            ...
            stringBuilder.AppendLine("# Настройка выдачи опыта");
            stringBuilder.AppendLine();
            stringBuilder.AppendLine("# Настройки статистики");
            ...
            AppendConfigValueWithComment(stringBuilder, nameof(config.PointsForDeath), config.PointsForDeath, "Очки за смерть - количество очков, вычитаемое у игрока за смерть.");
            ...
            AppendConfigValueWithComment(stringBuilder, nameof(config.PointsForDoubleKill), config.PointsForDoubleKill, "Очки за DoubleKill.");
            AppendConfigValueWithComment(stringBuilder, nameof(config.PointsForTripleKill), config.PointsForTripleKill, "Очки за TripleKill.");
            AppendConfigValueWithComment(stringBuilder, nameof(config.PointsForDomination), config.PointsForDomination, "Очки за Domination.");
            AppendConfigValueWithComment(stringBuilder, nameof(config.PointsForRampage), config.PointsForRampage, "Очки за Rampage.");
            AppendConfigValueWithComment(stringBuilder, nameof(config.PointsForMegaKill), config.PointsForMegaKill, "Очки за MegaKill.");
            AppendConfigValueWithComment(stringBuilder, nameof(config.PointsForOwnage), config.PointsForOwnage, "Очки за Ownage.");
            AppendConfigValueWithComment(stringBuilder, nameof(config.PointsForUltraKill), config.PointsForUltraKill, "Очки за UltraKill.");
            AppendConfigValueWithComment(stringBuilder, nameof(config.PointsForKillingSpree), config.PointsForKillingSpree, "Очки за KillingSpree.");
            AppendConfigValueWithComment(stringBuilder, nameof(config.PointsForMonsterKill), config.PointsForMonsterKill, "Очки за MonsterKill.");
            AppendConfigValueWithComment(stringBuilder, nameof(config.PointsForUnstoppable), config.PointsForUnstoppable, "Очки за Unstoppable.");
            AppendConfigValueWithComment(stringBuilder, nameof(config.PointsForGodLike), config.PointsForGodLike, "Очки за GodLike.");
        ...
        public void SavePhrasesConfig(PhrasesConfig config, string filePath)
        {
            ...
            stringBuilder.AppendLine("# Настройка сообщений плагина");
            stringBuilder.AppendLine();
            
            stringBuilder.AppendLine("# Префикс перед сообщением");
            stringBuilder.AppendLine($"Prefix: \"{EscapeMessage(config.Prefix)}\"");
            stringBuilder.AppendLine("# Данное сообщение отправляется в начале каждого раунда");
            stringBuilder.AppendLine($"IntroMessage: \"{EscapeMessage(config.IntroMessage)}\"");
            stringBuilder.AppendLine("# Сообщение о количестве активных игроков");
            ...
            stringBuilder.AppendLine("# Серии убийств");
            ...
            stringBuilder.AppendLine("# Меню подтверждения сброса статистики");
            ...
            stringBuilder.AppendLine("# Меню списка званий");
        ...
        [ConsoleCommand("rank", "Узнать свою статистику")]
        ...
        [ConsoleCommand("css_lvl_reload", "Перезагружает конфигурационные файлы")]
        public void ReloadConfigsCommand(CCSPlayerController? player, CommandInfo command)
        {
            if (player == null)
            {
                try
                {
                    ...
                    Console.WriteLine("[LR] Конфигурация успешно перезагружена.");
                }
                catch (Exception ex)
                {
                    Console.WriteLine($"[LR] Ошибка при перезагрузке конфигурации: {ex.Message}");
                }
            }
            else
            {
        ...
        [ConsoleCommand("css_lvl_take_points", "Забирает очки опыта у игрока. Использование: css_lvl_take_point <steamid64> <amount>")]
            ...
            if (player == null || player.IsBot) 
            {
                try
                {
                    ...
                    if (int.TryParse(command.ArgByIndex(2), out var amount))
                    {
                        ...
                        Console.WriteLine($"[LR] У игрока {steamId} (SteamID64: {steamId64}) было забрано {amount} очков опыта.");
                    }
                    else
                    {
                        Console.WriteLine("Неверное количество очков. Убедитесь, что вы ввели число.");
                    }
                }
                catch (Exception ex)
                {
                    Console.WriteLine($"[LR] Произошла ошибка при снятии очков опыта: {ex.Message}");
                }
            }
            else
            {
        ...
        [ConsoleCommand("css_lvl_give_points", "Выдает очки опыта игроку. Использование: css_lvl_give_point <steamid64> <amount>")]
            ...
            if (player == null || player.IsBot) 
            {
                try
                {
                    ...
                    if (int.TryParse(command.ArgByIndex(2), out var amount))
                    {
                        ...
                        Console.WriteLine($"[LR] {amount} очков опыта были добавлены игроку {steamId} (SteamID64: {steamId64}).");
                    }
                    else
                    {
                        Console.WriteLine("Неверное количество очков. Убедитесь, что вы ввели число.");
                ...
                {
                    Console.WriteLine($"[LR] Произошла ошибка при добавлении очков опыта: {ex.Message}");
                }
            }
            else
            {
        ...
        [ConsoleCommand("css_lvl_reset", "Очищает статистику игрока. Использование: css_lvl_reset <steamid64> <data-type>")]
        ...
        public void ResetRanksCommand(CCSPlayerController? player, CommandInfo command)
        {
            if (player == null || player.IsBot) 
            {
                try
                {
                    ...
                    switch (dataType)
                    {
                        case "exp":
                            ...
                            Console.WriteLine($"[LR] Опыт и ранг игрока {steamId} (SteamID64: {steamId64}) были сброшены.");
                            break;
                        case "stats":
                            ResetPlayerStats(steamId);
                            Console.WriteLine($"[LR] Статистика игрока {steamId} (SteamID64: {steamId64}) была сброшена.");
                            break;
                        case "time":
                            ResetPlayerPlaytime(steamId);
                            Console.WriteLine($"[LR] Время игры игрока {steamId} (SteamID64: {steamId64}) было сброшено.");
                            break;
                        default:
                ...
                {
                    Console.WriteLine($"[LR] Произошла ошибка при сбросе статистики: {ex.Message}");
                }
            }
            else
            {
