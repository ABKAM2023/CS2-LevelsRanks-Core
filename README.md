...
# RU
## Поддержка по плагину осуществляется на Discord сервере: https://discord.gg/ChYfTtrtmS. Также вы можете предлагать идеи и сообщать о найденных багах там же.
## Описание
